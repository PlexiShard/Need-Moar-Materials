...
public class ModelOgre extends ModelBase
{
  ...
  public ModelOgre()
  {
    ...
    textureHeight = 64;
      ...
      Right_Leg_part_1.setRotationPoint(-5.7F, 12F, 2F);
      ...
      Left_Leg_part_1.setRotationPoint(-1.3F, 12F, 2F);
      ...
      Left_forearm.setRotationPoint(2F, 7F, -1F);
      ...
      Right_Forearm.setRotationPoint(-8F, 7F, -1F);
  ...
  public void setRotationAngles(float time, float speed, float rotationAngle, float rotationYaw, float rotationPitch, float scale, Entity entity) {
		super.setRotationAngles(time, speed, rotationAngle, rotationYaw, rotationPitch, scale, entity);
	  	this.Left_Leg_part_1.rotateAngleX = MathHelper.cos(time * 0.6662F) * 1.4F * speed;
	  	this.Right_Leg_part_1.rotateAngleX = -(MathHelper.cos(time * 0.6662F) * 1.4F * speed);
	  	this.Body.rotateAngleX = 0.4730869F;
	  }
